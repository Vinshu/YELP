...
function processStyleUrl(node) {
  ...
  var createPolygon = function(placemark, doc) {
    ...
    //vinshu - polygon class protypal functionu
...
//end of prototypal function
  ...
  var createInfoWindow = function(placemark, doc, gObj) {
    ...
    google.maps.event.addListener(gObj, 'click', function(e) {
      ...
      console.log(gObj.title)

setStateName(gObj.title);

//vinshu - get bounds and Zoom function



this.map.fitBounds(gObj.bounds);
...
zoomChangeBoundsListener = 
    google.maps.event.addListenerOnce(this.map, 'bounds_changed', function(event) {
        ...
        if (this.getZoom()){
          //Below function adds buttons on second level
          showButtonBar();

         // console.log("executed zoom listener")
            this.setZoom(8);
        }
});
...
/*var a=this.map.getProjection().fromPointToLatLng(new google.maps.Point(x, y))
this.map.setZoom(7);
